...
# #1
st.write("  광주과학기술원(GIST)는 세계적인 경쟁력을 갖춘 글로벌캠퍼스로, 과학기술 인재양성에 초점을 맞추고 있습니다. 혁신적인 연구와 창의적인 교육을 통해 학생들을 세계 수준의 인재로 성장시키며, 다양한 분야에서 우수한 연구 성과를 거두고 있습니다. 또한 창업 지원을 통해 연구 성과를 실용적인 결과물로 이끌어내며, 국내외에서 미래를 이끌어가는 중요한 역할을 하고 있습니다.")

# #2
st.write("  본 웹사이트는 GIST 대학원의 분야와 분야별 연구실에 대한 정보를 글/채팅봇을 통해 제공하여 컨텍하는 학생들에게 편의를 제공하고자 한다.")
